...
const TextExcuse = ({ clicked, id }) => {
    ...
    if (!data) {
        response = <div className='flex justify-center'>
            <svg role="status" className="inline mr-2 w-8 h-8 text-gray-200 animate-spin fill-yellow-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
